...
- 🛡 **Инженеры ИБ** — проверка интуиции по построению defense-in-depth
...
// Certification cost (does NOT increase invested)
certCost = invested

// Regulator penalty (for uncertified SZI)
...
- Security Analyst усиливает 7 связанных СЗИ — ставьте его рано
